...
module.exports = {
    // the tcp port that the portal web server is listening on
    uiPort: 1990,

    // By default, the portal UI accepts connections on all IPv4 interfaces.
    // The following property can be used to listen on a specific interface. For
    // example, the following would only allow connections from the local machine.
   // uiHost: "127.0.0.1",
     uiHost: process.env.PORTAL_HOST,
    ...
    // By default, all user data is stored in the portal install directory. To
    // use a different location, the following property can be used
    //userDir: '/home/nol/.portal/',

    // portal scans the `nodes` directory in the install directory to find nodes.
    // The following property can be used to specify an additional directory to scan.
    //nodesDir: '/home/nol/.portal/nodes',

    // By default, the portal UI is available at http://localhost:1880/
    ...
    //httpStatic: '/home/nol/portal-dashboard/',
